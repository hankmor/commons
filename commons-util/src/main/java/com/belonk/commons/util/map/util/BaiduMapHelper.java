package com.belonk.commons.util.map.util;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.belonk.commons.util.http.HttpRequestUtil;
import com.belonk.commons.util.http.HttpSetting;
import com.belonk.commons.util.map.vo.BaiduMapGeocoder;
import com.belonk.commons.util.map.vo.BaiduMapLocate;
import com.belonk.commons.util.map.vo.BaiduMapUnGeocoder;
import com.belonk.commons.util.map.vo.BaiduPoint;
...
public class BaiduMapHelper {
    ...
    public static BaiduMapLocate locate(String baiduAkKey, String userIp) throws IOException {
        ...
        String json = HttpRequestUtil.sendRequest(locateUrl, httpSetting);
    ...
    public static BaiduMapGeocoder geocoder(String baiduAkKey, String address, String city) throws IOException {
        ...
        HttpSetting httpSetting = HttpSetting.newInstance();
        httpSetting.setIsGet(true);
        String json = HttpRequestUtil.sendRequest(generatorUrl, httpSetting);
        JSONObject jsonObject = JSON.parseObject(json);
        Integer status = jsonObject.getInteger("status");
